    ...
    rules: [
        ...
        rules: [
          {
            ...
            options: {
              ...
              plugins: [
                ...
                ...(isDev ? [] : ['@babel/plugin-transform-react-constant-elements']),
...

      {
        ...
        rules: [
          ...
          // Install dependencies before uncommenting: npm i -D less-loader less
          // {
          //   test: /\.less$/,
          //   loader: 'less-loader',
          //   options: {
          ...
          // Install dependencies before uncommenting: npm i -D sass-loader node-sass
          {
            test: /\.(scss|sass)$/,
            loader: 'sass-loader',
            options: {
...
const webpackEntry = {} as webpack.Entry;
